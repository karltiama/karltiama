...
- Designing end-to-end systems (frontend → backend → data pipelines)
- Building analytics platforms with real-world datasets
...
A real-time analytics system for evaluating player prop bets using automated data ingestion and custom projection models.

- AWS Lambda + EventBridge for scheduled ingestion  
- Raw → analytics PostgreSQL schema design  
- Historical odds tracking and EV-based analysis  
...
- Designing reliable data ingestion pipelines (Lambda and SQS fan-out)  
- Structuring analytics schemas for flexibility and performance  
- Avoiding hindsight bias in model evaluation using snapshot data  
